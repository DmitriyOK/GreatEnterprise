...
//        TestEntityDb.printList((EntityFactory.findEmployerWorkDayHistoryByPeriod(employer, currentDayUnixTime() - (86400 * 4), currentDayUnixTime()+86400)),"findEmployerWorkDayHistoryByPeriod");
...
//        System.out.println(Period.currentDayUnixTime());
