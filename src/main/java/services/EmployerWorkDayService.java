...
public interface EmployerWorkDayService {
     ...
     *
     * {@link sqlquery.SqlQuery#EMPLOYER_WORK_DAY_BY_PERIOD}
     ...
     * за заданный день.
     *
     * {@link sqlquery.SqlQuery#SELECTED_DAY_REPORT}
     ...
     *
     * {@link sqlquery.SqlQuery#CURRENT_DAY_REPORT}
     ...
     *
     * {@link sqlquery.SqlQuery#CURRENT_EMPLOYER_WORK_DAY}
     ...
     *
     * {@link sqlquery.SqlQuery#SET_STATUS}
     ...
     *
     * {@link sqlquery.SqlQuery#UPDATE_EMPLOYER_WORK_DAY_BEGIN}
     * {@link sqlquery.SqlQuery#UPDATE_EMPLOYER_WORK_DAY_END}
